	 	...
	 	<form:form method="POST" modelAttribute="message" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-lg-12">
					...
					<div class="col-lg-7">
						<form:input type="text" path="user.name" id="user.name" class="form-control input-sm" disabled="true"/>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-actions floatRight">
					<input type="submit" value="Edit" class="btn btn-primary btn-sm"/> <a href="<c:url value='/message' />" class="btn btn-info btn-sm">Cancel</a>
				</div>
			</div>
		</form:form>
	</div>
